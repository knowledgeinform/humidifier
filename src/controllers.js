...
const adamCtrlrAPI = require('./controller-adam-api.js')
...
class ControllersC {
  constructor({router, Description, Details, testFlag = true, type, index, services, serverInstance}) {
    ...
    } else if (type === 'adam-api') {
      Object.defineProperty(this, 'hidden', {
        value: new adamCtrlrAPI.Device({address: router,
          ID: this.Index.value,
          testFlag: testFlag,
          services: services,
          server: serverInstance,
...
var controllersMap = {
  0: {Description: '', Details: '', 'Controller Type': {value: 'Humidity Driver'}, index: '0'},
  '01': {Description: '', Details: '', 'Controller Type': {value: 'adam-api'}, index: '01'},
}
// var controllersMap = {}
